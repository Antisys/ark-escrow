...
The full output of a passing E2E run is in [E2E_TEST_OUTPUT.txt](E2E_TEST_OUTPUT.txt) — 50 steps across 6 scenarios with real Liquid transactions, atomic HTLC swaps, and Lightning payments. You can review exactly what each step does without installing anything.
